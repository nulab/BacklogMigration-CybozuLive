...
import com.nulabinc.backlog.c2b.persistence.interpreters.sqlite.tables.{CybozuUserTable, EventCommentTable, EventTable}
...
private[sqlite] case class EventTableOps()(implicit exc: ExecutionContext) extends BaseTableOps[CybozuDBEvent, EventTable] {
  ...
  private val commentTableQuery = TableQuery[EventCommentTable]
